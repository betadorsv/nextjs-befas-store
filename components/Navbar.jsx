...
const Navbar = () => {
  ...
  return (
    ...
    >
      <Head>
        <title>{page.toUpperCase() + " | BEFAS"}</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <link rel="shortcut icon" href="/logo_only_w.png" />
        <meta name="title" content="BEFAS" />

        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.befastm.com/" />
        <meta property="og:title" content="BEFAS" />
        <meta property="og:site_name" content="BEFAS" />
        <meta
          property="og:description"
          content="BEFAS"
        />
        <meta property="og:image" content="/logo_only_w.png" />
        <meta
          name="keywords"
          content="BEFAS"
        />
      ...
      <div className="flex  justify-between items-center">
        ...
        <Link href="/">
          <a className="pointer-events-auto">
            <Image src={Logo} id="brand" width="97" height="21" />
            {/* <motion.svg
              layoutId="loader"
              id="brand"
              width="129"
